...
void OrthographicCamera::glInit (int w, int h)
{
	...
	glLoadIdentity ();
	if (w > h)
		glOrtho (-imgSize / 2.0, imgSize / 2.0, -imgSize * (float)h / (float)w / 2.0, imgSize*(float)h / (float)w / 2.0, 0.5, 40.0);
	else
		glOrtho (-imgSize * (float)w / (float)h / 2.0, imgSize*(float)w / (float)h / 2.0, -imgSize / 2.0, imgSize / 2.0, 0.5, 40.0);
}
// ====================================================================
