...
public:
  ...
  void print (const Matrix m) {
	  cout << m.Get (0, 0) << " " << m.Get (0, 1) << " " << m.Get (0,2) << " " << m.Get (0, 3) << endl;
	  cout << m.Get (1, 0) << " " << m.Get (1, 1) << " " << m.Get (1, 2) << " " << m.Get (1, 3) << endl;
	  cout << m.Get (2, 0) << " " << m.Get (2, 1) << " " << m.Get (2, 2) << " " << m.Get (2, 3) << endl;
	  cout << m.Get (3, 0) << " " << m.Get (3, 1) << " " << m.Get (3, 2) << " " << m.Get (3, 3) << endl<<endl;
  }
  // INPUT / OUTPUT
